	...
	(function(h, o, g) {
		...
		g[h] = {
			...
			settings: {
				...
				createPlayer: {
					markup:
						'          <div class="play-pause">             <p class="play"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="34" viewBox="0 0 20 34"><g><g><path  d="M0 .787L19.213 17 0 33.213"/></g></g></svg></p>             <p class="pause"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="32" viewBox="0 0 10 32"><g><g><path  d="M0 0h3v32H0zm7 0h3v32H7z"/></g></g></svg></p>             <p class="loading"></p>             <p class="error"></p>           </div>           <div class="scrubber">             <div class="progress"></div>             <div class="loaded"></div>           </div>           <div class="time">             <em class="played">00:00</em>/<strong class="duration">00:00</strong>           </div>           <div class="error-message"></div>',
...
// 	function onYouTubeIframeAPIReady() {
// 			var temp = $(".people-video-box iframe");
